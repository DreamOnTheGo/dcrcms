...
if($step=="1" || empty($step)){
  ...
  <li class="Seperator"><hr></li>
  <LI class=SubmitBox><INPUT class="btn" type="button" onclick="location.href='index.php?step=2'" value="进入下一步" name=Submit></LI>
  </UL>
    </div>
<?php
}
...
<UL class=Form_Advance id=FormRegStep1>
  ...
  <DIV class=FormInput>
    <select name="db_type" id="db_type" onchange="ShowPanel()" style="padding:5px;">
  ...
  <span id="mysqlpanel" style="display:none">
  <li>
  ...
  <div class="Info">
    <div class="alert_txt"><div id="content_alert"></div></div>
  </div>
  <DIV class=HackBox></DIV></LI>
  </span>
  <li>
  ...
  <DIV class=HackBox></DIV></LI>  
  <li class="Seperator"><hr></li>
  <LI class=SubmitBox><INPUT class="btn" type=submit value="安装程序" name=Submit></LI></UL>
 </form>
