...
CKFinder.SetupCKEditor = function( editorObj, basePath, imageType, flashType )
{
	...
	//dcr 关闭浏览
	//dcr editorObj.config.filebrowserBrowseUrl = url ;
	//dcr editorObj.config.filebrowserImageBrowseUrl = url + qs + 'type=' + ( imageType || 'Images' ) ;
	//dcr editorObj.config.filebrowserFlashBrowseUrl = url + qs + 'type=' + ( flashType || 'Flash' ) ;
